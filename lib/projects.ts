...
export const projects: Project[] = [
  {
    ...
    shortDescription:
      "Client-side Python web app that converts unlimited pages of PDF bank statements to Excel.",
    category: "Web Apps",
    techStack: ["Next.js", "React", "Tailwind CSS", "Pyodide", "Python"],
    frontend: ["Next.js", "React", "Tailwind CSS"],
    backend: [],
    database: [],
    devops: ["Vercel"],
    features: [
      "Client-side Python execution for processing PDFs",
      "Support for multiple bank statement formats",
      "Unlimited page conversion capability",
      "Secure processing (files never leave the browser)",
    ...
    liveUrl: "https://bank-converter.royadma.dev",
  }
]
